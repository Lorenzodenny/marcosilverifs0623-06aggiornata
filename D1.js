...
let celsius= prompt("quanti gradi celsius fanno da te?")
...
let ilNome= prompt("come ti chiami")

let ilCognome= prompt("qual'è il tuo cognome")

let anni= prompt("quanti anni hai")

window.alert("ciao" + " " + ilNome + " " + ilCognome + " " + "di" + " " + anni + " " + "anni" + ", " + "fà" + " " + fahrenheit1 + " " + "gradi fahrenheit")